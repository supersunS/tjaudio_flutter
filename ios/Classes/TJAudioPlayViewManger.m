...
-(void)setAudioState:(STKAudioPlayerState)audioState{
    if([TJAudioPlayManager getAudioIsPlaying]){
        ...
        [_playStateBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_pause"] forState:UIControlStateNormal];
        [_playStateBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_pause"] forState:UIControlStateHighlighted];
    }else{
        [_openViewBtn stopAnimation];
        [_playStateBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_play"] forState:UIControlStateNormal];
        [_playStateBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_play"] forState:UIControlStateHighlighted];
    }
}
...
-(void)setSourceCount:(NSInteger)sourceCount{
    ...
    if(_sourceCount > 1){
        [_playNextAudioBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_next"] forState:UIControlStateNormal];
        [_playNextAudioBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_next"] forState:UIControlStateHighlighted];
        _playNextAudioBtn.userInteractionEnabled = YES;
    }else{
        [_playNextAudioBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_unnext"] forState:UIControlStateNormal];
        [_playNextAudioBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_unnext"] forState:UIControlStateHighlighted];
...
-(UIButton *)closeAudioBtn{
    if(!_closeAudioBtn){
        ...
        [_closeAudioBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_close"] forState:UIControlStateNormal];
        [_closeAudioBtn setImage:[TJAudioPlayManager tj_imageNamed:@"audio_icon_close"] forState:UIControlStateHighlighted];
