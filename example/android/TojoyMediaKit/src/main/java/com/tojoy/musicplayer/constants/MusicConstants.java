package com.tojoy.musicplayer.constants;
...
//    float BASE_SCREEN_HEIGHT = (float) 1920.0;
    ...
    //前台进程通知群组ID
    String CHANNEL_ID = "com.android.tojoy.music.mediaplayer";
    /**
     * 通知交互ACTION
     */
    //点击通知栏
    String MUSIC_INTENT_ACTION_ROOT_VIEW = "TJ_MUSIC_INTENT_ACTION_CLICK_ROOT_VIEW";
    //上一首
    String MUSIC_INTENT_ACTION_CLICK_LAST = "TJ_MUSIC_INTENT_ACTION_CLICK_LAST";
    //下一首
    String MUSIC_INTENT_ACTION_CLICK_NEXT = "TJ_MUSIC_INTENT_ACTION_CLICK_NEXT";
    //暂停、开始
    String MUSIC_INTENT_ACTION_CLICK_PAUSE = "TJ_MUSIC_INTENT_ACTION_CLICK_PAUSE";
    //关闭通知栏
    String MUSIC_INTENT_ACTION_CLICK_CLOSE = "TJ_MUSIC_INTENT_ACTION_CLICK_CLOSE";
    //收藏
    String MUSIC_INTENT_ACTION_CLICK_COLLECT = "TJ_MUSIC_INTENT_ACTION_CLICK_COLLECT";

    String MUSIC_INTENT_ACTION_CLICK_DELECT="TJ_MUSIC_INTENT_ACTION_CLICK_DELECT";
    //参数传入
    String MUSIC_KEY_MEDIA_ID = "TJ_MUSIC_KEY_MEDIA_ID";

    /**
     * 播放器内部各种状态，替换enum类型
     */
    int MUSIC_PLAYER_STOP    = 0; //已结束
    ...
    int MUSIC_PLAYER_INIT=8;//未开始
    int VEDIO_PLAYER_PAUSE   = 6; //暂停
    int VEDIO_PLAYER_PLAYING   = 7; //播放中
